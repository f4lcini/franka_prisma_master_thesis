...
def create_tree(task_description="Default Task"):
    ...
    mock_plan = [
        {"action": "PICK", "target_name": "base_pose", "arm": "right_arm"},
        {"action": "PLACE", "target_location": "shared", "arm": "right_arm"},
        {"action": "MOVE_HOME", "arm": "right_arm"},
        {"action": "WAIT", "arm": "left_arm", "message": "wait"},
        {"action": "PICK", "target_name": "shared", "arm": "left_arm"},
        {"action": "PLACE", "target_location": "box", "arm": "left_arm"},
        {"action": "MOVE_HOME", "arm": "left_arm"}
    ]
    vlm_planner = py_trees.behaviours.SetBlackboardVariable(
        name="Mock_VLM_Planner",
        variable_name="vlm_plan",
        variable_value=mock_plan,
        overwrite=True
    )
